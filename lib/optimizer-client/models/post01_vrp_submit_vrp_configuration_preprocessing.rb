...
module OptimizerClient
  ...
  class Post01VrpSubmitVrpConfigurationPreprocessing
    ...
    # Forces centroid indices used to generate clusters with kmeans partition_method. Available only with deprecated partition_method.
    ...
    def hash
      [max_split_size, kmeans_centroids, cluster_threshold, force_cluster, prefer_short_segment, neighbourhood_size, partitions, first_solution_strategy].hash
    end
