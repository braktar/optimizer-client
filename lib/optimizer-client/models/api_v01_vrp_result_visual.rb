...
module OptimizerClient
  class ApiV01VrpResultVisual
    # According to specified geometry and partitions parameter, geojsons representing each partition
    attr_accessor :partitions

    # Points visualization
    attr_accessor :points

    # Polylines visualization
    ...
    def self.swagger_types
      {
        :'partitions' => :'ApiV01VrpResultVisualClusters',
        :'points' => :'String',
        :'polylines' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'polylines')
        self.polylines = attributes[:'polylines']
      end
    end
    ...
    def hash
      [partitions, points, polylines].hash
    end
