...
module OptimizerClient
  class Post01VrpSubmitVrpUnits
    attr_accessor :id

    # Name of the unit
    attr_accessor :label

    # Define if the unit is a counting one, which allows to count the number of stops in a single route
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'counting')
        self.counting = attributes[:'counting']
      end
    end
