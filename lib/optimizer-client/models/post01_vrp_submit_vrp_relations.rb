...
module OptimizerClient
  class Post01VrpSubmitVrpRelations
    ...
    attr_accessor :linked_vehicles_ids
    ...
    def self.attribute_map
      {
        ...
        :'linked_vehicles_ids' => :'linked_vehicles_ids'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'linked_vehicles_ids')
        self.linked_vehicles_ids = attributes[:'linked_vehicles_ids']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          linked_vehicles_ids == o.linked_vehicles_ids
    end
    ...
    def hash
      [id, type, lapse, linked_ids, linked_vehicle_ids, periodicity, linked_vehicles_ids].hash
    end
