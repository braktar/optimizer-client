...
module OptimizerClient
  class VrpResultSolution
    ...
    # cumulated distance of every route
    attr_accessor :total_distance

    # Cumulated time of every route
    ...
    def self.attribute_map
      {
        :'heuristics_synthesis' => :'heuristics_synthesis',
        :'solvers' => :'solvers',
        :'cost' => :'cost',
    ...
    def self.swagger_types
      {
        ...
        :'start_time' => :'Integer',
        :'end_time' => :'Integer',
        :'routes' => :'Array<VrpResultSolutionRoute>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'heuristics_synthesis')
        self.heuristics_synthesis = attributes[:'heuristics_synthesis']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          heuristics_synthesis == o.heuristics_synthesis &&
          solvers == o.solvers &&
          cost == o.cost &&
    ...
    def hash
      [heuristics_synthesis, solvers, cost, total_distance, total_time, start_time, end_time, routes, unassigned].hash
    end
