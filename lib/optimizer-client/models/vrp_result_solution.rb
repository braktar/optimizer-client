...
module OptimizerClient
  class VrpResultSolution
    ...
    def self.swagger_types
      {
        ...
        :'unassigned' => :'Array<VrpResultSolutionUnassigneds>'
      }
    end
    ...
    def hash
      [heuristics_synthesis, solvers, cost, iterations, total_distance, total_time, start_time, end_time, routes, unassigned].hash
    end
