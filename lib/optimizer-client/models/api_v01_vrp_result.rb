...
module OptimizerClient
  # Api_V01_VrpResult model
  class ApiV01VrpResult
    # The current best solution
    attr_accessor :solutions

    # If required through geometry VRP parameter, set of geojsons generated
    attr_accessor :geojsons
    ...
    def self.swagger_types
      {
        :'solutions' => :'Array<ApiV01VrpResultSolution>',
        :'geojsons' => :'Array<ApiV01VrpResultVisual>',
        :'job' => :'ApiV01VrpResultJob'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'geojsons')
        if (value = attributes[:'geojsons']).is_a?(Array)
          self.geojsons = value
        end
      end
