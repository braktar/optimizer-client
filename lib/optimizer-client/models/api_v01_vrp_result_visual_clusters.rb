...
module OptimizerClient
  class ApiV01VrpResultVisualClusters
    # Vehicle partition visual
    attr_accessor :vehicle

    # Work_day partition visual
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'work_day')
        self.work_day = attributes[:'work_day']
      end
    end
