...
module OptimizerClient
  class Post01VrpSubmitVrpShipments
    ...
    # When activated, vehicle should go directly to delivery point after pick up
    attr_accessor :direct

    # Define the entities which are taken and dropped. The maximum precision supported is 1e-3.
    ...
    def self.swagger_types
      {
        ...
        :'skills' => :'Array<String>',
        :'pickup' => :'Post01VrpSubmitVrpPickup',
        :'delivery' => :'Post01VrpSubmitVrpDelivery',
        :'direct' => :'BOOLEAN',
    ...
    def hash
      [id, priority, exclusion_cost, visits_number, unavailable_visit_indices, unavailable_visit_day_indices, unavailable_visit_day_date, minimum_lapse, maximum_lapse, maximum_inroute_duration, sticky_vehicle_ids, skills, pickup, delivery, direct, quantities, unavailable_index_ranges, unavailable_date_ranges].hash
    end
