...
module OptimizerClient
  class Post01VrpSubmitVrpRoutes
    # vehicle linked to the current described route
    attr_accessor :vehicle_id

    # Indice of the route. Must be provided if first_solution_strategy is 'periodic'.
    attr_accessor :indice

    # Date of the route. Must be provided if first_solution_strategy is 'periodic'.
    attr_accessor :date

    # Initial state or partial state of the current vehicle route
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'indice')
        self.indice = attributes[:'indice']
      end
    ...
    def list_invalid_properties
      ...
      if @mission_ids.nil?
        invalid_properties.push('invalid value for "mission_ids", mission_ids cannot be nil.')
      end
    ...
    def valid?
      return false if @mission_ids.nil?
      true
    end
    ...
    def hash
      [vehicle_id, indice, date, mission_ids, day].hash
    end
