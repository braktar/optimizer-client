...
module OptimizerClient
  class Post01VrpSubmitVrpConfigurationResolution
    ...
    def hash
      [duration, iterations, iterations_without_improvment, stable_iterations, stable_coefficient, initial_time_out, minimum_duration, time_out_multiplier, vehicle_limit, solver_parameter, solver, same_point_day, allow_partial_assignment, split_number, evaluate_only, several_solutions, variation_ratio].hash
    end
