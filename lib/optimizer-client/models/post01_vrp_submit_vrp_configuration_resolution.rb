...
module OptimizerClient
  class Post01VrpSubmitVrpConfigurationResolution
    ...
    # [ DEPRECATED : use minimum_duration instead]
    ...
    # [ DEPRECATED : use preprocessing_first_solution_strategy instead ]
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'initial_time_out')
        self.initial_time_out = attributes[:'initial_time_out']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          initial_time_out == o.initial_time_out &&
    ...
    def hash
      [duration, iterations, iterations_without_improvment, stable_iterations, stable_coefficient, initial_time_out, minimum_duration, time_out_multiplier, vehicle_limit, solver_parameter, solver, same_point_day, allow_partial_assignment, split_number, evaluate_only, several_solutions, batch_heuristic, variation_ratio].hash
    end
