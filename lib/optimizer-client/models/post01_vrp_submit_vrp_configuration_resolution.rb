...
module OptimizerClient
  ...
  class Post01VrpSubmitVrpConfigurationResolution
    ...
    # (Scheduling heuristic only) Starts filling earlier days of the period first and minimizes the total number of days worked. Available only if first_solution_strategy is 'periodic'. Not available with ORtools.
    attr_accessor :minimize_days_worked

    # (Scheduling only) Forces all services with the same point_id to take place on the same days. Available only if first_solution_strategy is 'periodic'. Not available ORtools.
    attr_accessor :same_point_day

    # (Scheduling heuristic only) Considers a solution as valid even if only a subset of the visits of a service is performed. If disabled, a service can only appear fully assigned or fully unassigned in the solution. Not available with ORtools.
    ...
    def self.attribute_map
      {
        ...
        :'solver' => :'solver',
        :'minimize_days_worked' => :'minimize_days_worked',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'minimize_days_worked')
        self.minimize_days_worked = attributes[:'minimize_days_worked']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          solver == o.solver &&
          minimize_days_worked == o.minimize_days_worked &&
    ...
    def hash
      [duration, iterations_without_improvment, minimum_duration, time_out_multiplier, vehicle_limit, solver, minimize_days_worked, same_point_day, allow_partial_assignment, split_number, evaluate_only, several_solutions, batch_heuristic, variation_ratio].hash
    end
