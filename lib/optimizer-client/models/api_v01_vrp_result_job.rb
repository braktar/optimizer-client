...
module OptimizerClient
  class ApiV01VrpResultJob
    # Job uniq ID
    attr_accessor :id

    # One of queued, working, completed, killed or failed
    attr_accessor :status

    # Free form advancement message
    attr_accessor :avancement

    # Items to plot cost evolution
    attr_accessor :graph
    ...
    def self.swagger_types
      {
        ...
        :'status' => :'String',
        :'avancement' => :'String',
        :'graph' => :'Array<ApiV01VrpResultJobGraphItem>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'avancement')
        self.avancement = attributes[:'avancement']
      end

      if attributes.has_key?(:'graph')
        if (value = attributes[:'graph']).is_a?(Array)
          self.graph = value
        end
      end
    end
    ...
    def hash
      [id, status, avancement, graph].hash
    end
