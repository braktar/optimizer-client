...
module OptimizerClient
  class ApiV01VrpResultSolutionUnassigned
    ...
    # Unassigned reason. Only available when activity was rejected within preprocessing fase or periodic first_solution_strategy.
    ...
    def hash
      [point_id, service_id, pickup_shipment_id, delivery_shipment_id, rest_id, detail, type, reason].hash
    end
