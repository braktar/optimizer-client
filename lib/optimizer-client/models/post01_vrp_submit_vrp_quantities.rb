...
module OptimizerClient
  class Post01VrpSubmitVrpQuantities
    attr_accessor :id

    # Unit related to this quantity
    attr_accessor :unit_id

    # Allows to fill with quantity, until this unit vehicle capacity is full
    attr_accessor :fill

    # Allows to empty this quantity, until this unit vehicle capacity reaches zero
    attr_accessor :empty

    # Value of current quantity
    attr_accessor :value

    # If the associated unit is a counting one, defines the default value to count for this stop (additional quantities for this specific service are to define with the value tag)
    ...
    def hash
      [id, unit_id, fill, empty, value, setup_value].hash
    end
