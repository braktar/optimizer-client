...
module OptimizerClient
  class ApiV01VRPResultDetailedCosts
    # Cumulated cost
    attr_accessor :total

    # Cost associated to the use of the vehicle
    attr_accessor :fixed

    # Cost associated to the time dimension
    attr_accessor :time

    # Cost associated to the distance dimension
    attr_accessor :distance

    # Cost associated to the value dimension
    attr_accessor :value

    # Cost associated to late arrival
    attr_accessor :lateness

    # Cost associated to quantities overload
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'lateness')
        self.lateness = attributes[:'lateness']
      end
    ...
    def hash
      [total, fixed, time, distance, value, lateness, overload].hash
    end
