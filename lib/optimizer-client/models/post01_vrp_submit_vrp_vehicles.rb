...
module OptimizerClient
  class Post01VrpSubmitVrpVehicles
    ...
    # Particular abilities which could be handle by the vehicle. Not available with periodic heuristic.
    ...
    def hash
      [id, cost_fixed, cost_distance_multiplier, cost_time_multiplier, cost_value_multiplier, cost_waiting_time_multiplier, cost_late_multiplier, cost_setup_time_multiplier, coef_setup, additional_setup, coef_service, additional_service, force_start, shift_preference, trips, matrix_id, value_matrix_id, router_mode, router_dimension, speed_multiplier, speed_multiplier_area, traffic, track, motorway, toll, trailers, weight, weight_per_axle, height, width, length, hazardous_goods, max_walk_distance, approach, snap, strict_restriction, duration, overall_duration, distance, maximum_ride_time, maximum_ride_distance, skills, unavailable_work_day_indices, free_approach, free_return, start_point_id, end_point_id, rest_ids, capacities, sequence_timewindows, timewindow].hash
    end
