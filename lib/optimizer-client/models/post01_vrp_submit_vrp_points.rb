...
module OptimizerClient
  class Post01VrpSubmitVrpPoints
    attr_accessor :id

    # Index within the matrices, required if the matrices are already given
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'matrix_index')
        self.matrix_index = attributes[:'matrix_index']
      end
