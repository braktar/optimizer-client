...
module OptimizerClient
  ...
  class Post01VrpSubmitVrpConfigurationSchedule
    ...
    # (Scheduling only) Exclude some days indices from the resolution
    attr_accessor :unavailable_indices

    # (Scheduling only) Exclude some days from the resolution
    attr_accessor :unavailable_date

    # (Scheduling only) Day index ranges where no routes should be generated
    attr_accessor :unavailable_index_ranges

    # (Scheduling only) Date ranges where no routes should be generated
    ...
    def hash
      [range_indices, range_date, unavailable_indices, unavailable_date, unavailable_index_ranges, unavailable_date_ranges].hash
    end
