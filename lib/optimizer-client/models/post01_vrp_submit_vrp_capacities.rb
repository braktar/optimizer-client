...
module OptimizerClient
  class Post01VrpSubmitVrpCapacities
    attr_accessor :id

    # Unit of the capacity
    attr_accessor :unit_id

    # Maximum capacity that can be carried
    attr_accessor :limit

    # Initial quantity value loaded in the vehicle
    attr_accessor :initial

    # Allows to exceed the limit against this cost (ORtools only)
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'overload_multiplier')
        self.overload_multiplier = attributes[:'overload_multiplier']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          limit == o.limit &&
          initial == o.initial &&
          overload_multiplier == o.overload_multiplier
    end
    ...
    def hash
      [id, unit_id, limit, initial, overload_multiplier].hash
    end
