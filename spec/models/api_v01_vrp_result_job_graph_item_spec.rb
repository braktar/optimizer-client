...
# Unit tests for OptimizerClient::ApiV01VrpResultJobGraphItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApiV01VrpResultJobGraphItem' do
  before do
    # run before each test
    @instance = OptimizerClient::ApiV01VrpResultJobGraphItem.new
  end
  ...
  describe 'test an instance of ApiV01VrpResultJobGraphItem' do
    it 'should create an instance of ApiV01VrpResultJobGraphItem' do
      expect(@instance).to be_instance_of(OptimizerClient::ApiV01VrpResultJobGraphItem)
    end
  end
