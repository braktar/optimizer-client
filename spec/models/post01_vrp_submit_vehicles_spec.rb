...
# Unit tests for OptimizerClient::Post01VrpSubmitVehicles
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Post01VrpSubmitVehicles' do
  before do
    # run before each test
    @instance = OptimizerClient::Post01VrpSubmitVehicles.new
  end
  ...
  describe 'test an instance of Post01VrpSubmitVehicles' do
    it 'should create an instance of Post01VrpSubmitVehicles' do
      expect(@instance).to be_instance_of(OptimizerClient::Post01VrpSubmitVehicles)
    end
  end
  ...
  describe 'test attribute "shift_preference"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["force_start", "force_end", "minimize_span"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.shift_preference = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "hazardous_goods"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["explosive", "gas", "flammable", "combustible", "organic", "poison", "radio_active", "corrosive", "poisonous_inhalation", "harmful_to_water", "other"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.hazardous_goods = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "approach"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["unrestricted", "curb"])
      # validator.allowable_values.each do |value|
      #   expect { @instance.approach = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "timewindow_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
