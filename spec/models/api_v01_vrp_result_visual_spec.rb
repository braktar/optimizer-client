...
# Unit tests for OptimizerClient::ApiV01VrpResultVisual
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApiV01VrpResultVisual' do
  before do
    # run before each test
    @instance = OptimizerClient::ApiV01VrpResultVisual.new
  end
  ...
  describe 'test an instance of ApiV01VrpResultVisual' do
    it 'should create an instance of ApiV01VrpResultVisual' do
      expect(@instance).to be_instance_of(OptimizerClient::ApiV01VrpResultVisual)
    end
  end
  ...
  describe 'test attribute "polylines"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
