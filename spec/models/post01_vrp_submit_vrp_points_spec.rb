...
# Unit tests for OptimizerClient::Post01VrpSubmitVrpPoints
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Post01VrpSubmitVrpPoints' do
  before do
    # run before each test
    @instance = OptimizerClient::Post01VrpSubmitVrpPoints.new
  end
  ...
  describe 'test an instance of Post01VrpSubmitVrpPoints' do
    it 'should create an instance of Post01VrpSubmitVrpPoints' do
      expect(@instance).to be_instance_of(OptimizerClient::Post01VrpSubmitVrpPoints)
    end
  end
  ...
  describe 'test attribute "matrix_index"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
