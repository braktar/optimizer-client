...
# Unit tests for OptimizerClient::ApiV01VrpResult
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApiV01VrpResult' do
  before do
    # run before each test
    @instance = OptimizerClient::ApiV01VrpResult.new
  end
  ...
  describe 'test an instance of ApiV01VrpResult' do
    it 'should create an instance of ApiV01VrpResult' do
      expect(@instance).to be_instance_of(OptimizerClient::ApiV01VrpResult)
    end
  end
