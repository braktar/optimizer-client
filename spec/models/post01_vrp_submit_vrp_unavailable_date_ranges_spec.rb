...
# Unit tests for OptimizerClient::Post01VrpSubmitVrpUnavailableDateRanges
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Post01VrpSubmitVrpUnavailableDateRanges' do
  before do
    # run before each test
    @instance = OptimizerClient::Post01VrpSubmitVrpUnavailableDateRanges.new
  end
  ...
  describe 'test an instance of Post01VrpSubmitVrpUnavailableDateRanges' do
    it 'should create an instance of Post01VrpSubmitVrpUnavailableDateRanges' do
      expect(@instance).to be_instance_of(OptimizerClient::Post01VrpSubmitVrpUnavailableDateRanges)
    end
  end
