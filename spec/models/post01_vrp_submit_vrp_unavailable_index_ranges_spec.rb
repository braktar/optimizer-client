...
# Unit tests for OptimizerClient::Post01VrpSubmitVrpUnavailableIndexRanges
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Post01VrpSubmitVrpUnavailableIndexRanges' do
  before do
    # run before each test
    @instance = OptimizerClient::Post01VrpSubmitVrpUnavailableIndexRanges.new
  end
  ...
  describe 'test an instance of Post01VrpSubmitVrpUnavailableIndexRanges' do
    it 'should create an instance of Post01VrpSubmitVrpUnavailableIndexRanges' do
      expect(@instance).to be_instance_of(OptimizerClient::Post01VrpSubmitVrpUnavailableIndexRanges)
    end
  end
