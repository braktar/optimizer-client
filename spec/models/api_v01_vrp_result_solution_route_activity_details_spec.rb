...
# Unit tests for OptimizerClient::ApiV01VrpResultSolutionRouteActivityDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApiV01VrpResultSolutionRouteActivityDetails' do
  before do
    # run before each test
    @instance = OptimizerClient::ApiV01VrpResultSolutionRouteActivityDetails.new
  end
  ...
  describe 'test an instance of ApiV01VrpResultSolutionRouteActivityDetails' do
    it 'should create an instance of ApiV01VrpResultSolutionRouteActivityDetails' do
      expect(@instance).to be_instance_of(OptimizerClient::ApiV01VrpResultSolutionRouteActivityDetails)
    end
  end
