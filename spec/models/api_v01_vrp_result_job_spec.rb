...
# Unit tests for OptimizerClient::ApiV01VrpResultJob
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ApiV01VrpResultJob' do
  before do
    # run before each test
    @instance = OptimizerClient::ApiV01VrpResultJob.new
  end
  ...
  describe 'test an instance of ApiV01VrpResultJob' do
    it 'should create an instance of ApiV01VrpResultJob' do
      expect(@instance).to be_instance_of(OptimizerClient::ApiV01VrpResultJob)
    end
  end
  ...
  describe 'test attribute "avancement"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
